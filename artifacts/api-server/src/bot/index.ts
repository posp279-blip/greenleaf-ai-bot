...
import { runJarvisV11SelfAudit } from "./jarvisSelfAuditV11.js";
...
function scheduleAudit(): void {
  ...
  auditScheduled = true;
  setTimeout(() => {
    void runJarvisV11SelfAudit().catch((err) => logger.error({ err, audit: "JARVIS_V11_RELEASE" }, "V11 audit unhandled failure"));
  }, 1500);
}
